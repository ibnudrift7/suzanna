        ...
        */ ?>
        ...
        <li class="dropdown"><a href="#"><span class="fa fa-folder"></span> <?php echo Tt::t('admin', 'Static Page') ?></a>
            <ul>
                ...
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/about')); ?>">About Us</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/product')); ?>">Products Executives</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/partner')); ?>">Partnership</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/store_locator')); ?>">Store Locator</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/contact')); ?>">Contact Us</a></li>
            </ul>
        </li>
